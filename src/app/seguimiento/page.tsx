...
export default async function FollowupPage(){
 ...
 return <main className="mx-auto max-w-lg p-8 pt-20"><h1 className="text-2xl font-bold">Acceso al seguimiento</h1><p className="my-6">{error instanceof FollowupError?error.message:'El servicio no está disponible. Inténtalo de nuevo.'}</p><form action={followupLogout}><button className="rounded-lg bg-primary px-5 py-3 text-white">Cerrar sesión</button></form></main>;
 }
