...
export default function WhatsAppFloatingBtn() {
    ...
    // Three states for bottom position:
    // - Expanded bar (68px tall): lift above it → 84px
    // - Minimized orb (56px at bottom:28px): lift above it → 92px
    // - No player: default → 24px
    const bottom = radio.isVisible
        ? radio.isMinimized ? '92px' : '84px'
        : '24px';
